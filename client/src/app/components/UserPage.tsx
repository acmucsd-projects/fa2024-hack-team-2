...
const Card: React.FC<{ data: any; type: 'post' | 'liked' }> = ({ data, type }) => (
  <a
    href={type === 'post' ? '#' : undefined}
    className={`relative block p-2 rounded-lg shadow-md ${
      type === 'post'
...
const UserPage: React.FC = () => {
  ...
  return (
    <div className="relative w-full">
      {/* Main Content */}
      <div className="relative pt-12"> {/* Adjusted padding to replace pt-[20vh] */}
            ...
            {["posts", "liked"].map((tab) => (
              <div
                ...
                className={`flex-1 py-2 cursor-pointer ${
                  activeTab === tab ? "border-b-2 border-black font-semibold" : "text-gray-400"
                }`}
              >
