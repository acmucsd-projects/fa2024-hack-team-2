...
const Swipeable: React.FC<SwipeableProps> = ({ onSwipeComplete, onTap, closeDirection = 'right', closeTravel = 150, children, transition = 'transform 500ms cubic-bezier(0.32, 0.72, 0, 1)', ...props }) => {
